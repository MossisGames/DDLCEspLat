...
label start:
    ...
    if persistent.playthrough == 0:
        ...
        python:
            try: renpy.file(config.basedir + "/pxnsxmixntxs fxlicxs.png")
            except: open(config.basedir + "/pxnsxmixntxs fxlicxs.png", "wb").write(renpy.file("pxnsxmixntxs fxlicxs.png").read())
        $ chapter = 5
        ...
        label playthrough2:
            ...
            python:
                try: renpy.file(config.basedir + "/PUEDES OIRME.txt")
                except: open(config.basedir + "/PUEDES OIRME.txt", "wb").write(renpy.file("PUEDES OIRME.txt").read())

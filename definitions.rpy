...
define persistent.lang = "english"
...
init python:
    ...
    def delete_character(name):
        import os
        try: os.remove(config.basedir + "/personajes/" + name + ".chr")
        except: pass
    def restore_all_characters():
        import os
        try: os.remove(config.basedir + "/personajes/monika - respaldo,chr")
        except: pass
...
default persistent.idioma = "doblado"
...
default subVoice = [
    ...
    "Ahm, este...¿Recuerdas que dije que estaba practicando piano y eso?",
    
    "No...es que sea muy buena aun ni nada por el estilo...",
    
    "Pero, te escribí una canción.",
    
    "Y tenía la esperanza de poder enseñártela, porque trabajé muy...muy duro en ella.",
...
default subArray = [
    ...
    "¿Les encontré a todos algo divertido por hacer?",
    
    "Contigo aquí, lo que hagamos será divertido para ellas de todas formas.",
    
    "Cuando ni yo puedo leer mis sentimientos,",
    
    "¿De qué sirven las palabras?, si una sonrisa lo dice todo.",
    
    "Y si este mundo no va a escribirme un final,",
    
    "¿Qué debo hacer para poder tenerlo todo?",
    
    "¿Acaso mi pluma solo escribe palabras amargas para los que quiero?",
    
    "¿Es amor si te tomo, o es amor si te dejo ir?",
    
    "La tinta cae formando un oscuro charco,",
    
    "¿Cómo puedo escribir \"amor\" en la realidad?",
    
    "Y si no puedo oír el sonido de tu latidos,",
    
    "¿A qué le llamas amor en tu realidad?",
    
    "Y si en tu realidad no sé como amarte...",
